...
class Algorithms {
public:
    static glm::u32vec2 AStar(glm::i32vec2 start, glm::i32vec2 end, std::vector<bool> map, uint32_t width, uint32_t height);
    ...
    static std::vector<glm::vec2> MidpointCicle(glm::vec2 centre, float radius);
    static std::vector<glm::ivec2> MidpointCicle(glm::ivec2 centre, int32_t radius);
};
