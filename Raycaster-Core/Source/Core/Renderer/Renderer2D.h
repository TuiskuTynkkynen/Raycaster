...
namespace Core {
	...
	public: 
		...
		static void DrawRotatedFlatTriangle(const glm::vec3& position, float rotation, const glm::vec3& rotationAxis, const glm::vec3& scale, const glm::vec3& colour);
		static void DrawLine(const glm::vec3& position, const glm::vec3& scale, const glm::vec3& colour);
